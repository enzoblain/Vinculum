...
impl Value {
    #[allow(dead_code)]
    pub(super) fn into_int8(self) -> i8 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_int16(self) -> i16 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_int32(self) -> i32 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_int64(self) -> i64 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_word8(self) -> u8 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_word16(self) -> u16 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_word32(self) -> u32 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_word64(self) -> u64 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_float32(self) -> f32 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_float64(self) -> f64 {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_bool(self) -> bool {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn into_char(self) -> char {
        match self {
    ...
    #[allow(dead_code)]
    pub(super) fn encode_slice(args: &[Value]) -> Vec<u8> {
        let mut buf = Vec::new();
    ...
    pub(super) fn from_bytes(bytes: &[u8]) -> Value {
        let tag = bytes[0];
